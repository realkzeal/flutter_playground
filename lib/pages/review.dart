         ...
         child: ListView(
           children: [
             Text('Review Transaction',
               textAlign: TextAlign.center, style: headline1Style,),
             const SizedBox(height: 15,),
             Text(
                 'Kindly review this transaction before proceeding',
             ...
             Container(
               ...
               child: Column(
                 children: [
                   ...
                   Divider(),
                   ReviewCard(
                     title: 'Bank Name',value: widget.review.bankName ?? "",
                   ),
                   const Divider(),
                   ReviewCard(
                       title: 'Account Number', value: widget.review.acctNumber ?? ""),
                   const Divider(),
                   ReviewCard(
                     title: 'Amount', value: '\$ ${widget.review.amount ?? "0.00"}',
                   ),
                   Divider(),
                   ReviewCard(
                     title: 'Description', value: widget.review.description ?? "",
                   )
                 ],
               ),
             ),
               ...
               child: Button(
                 ...
                 onPressed: (){
                   Navigator.of(context).pushReplacement(
                     MaterialPageRoute(builder: (context) => Processing(data: widget.review)),
                   );
                 },
               )
             )
